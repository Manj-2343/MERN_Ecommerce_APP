    ...
    <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2 mt-1 bg-gray-100 rounded-full p-1 w-fit">
          <Button
            variant="ghost"
            className="h-8 w-8 rounded-full hover:text-white bg-gradient-to-l from-slate-800 to-purple-900 hover:bg-gradient-to-r from-slate-800 to-purple-900 text-white transition-colors duration-300"
            size="icon"
